...
CREATE TRIGGER TG2_act_valor_jugador
ON inf_transf_detalle
AFTER INSERT
AS
BEGIN
...
-------------------------------------------------------------------------------------------------------
INSERT INTO club_jugador(nro_club,nro_jugador) VALUES(2,1)
INSERT INTO inf_transf_detalle(nro_informe,nro_club,nro_jugador,valor_transf) VALUES(1,2,1,15000000)
